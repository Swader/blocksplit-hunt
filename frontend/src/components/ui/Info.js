...
const HelpInformation = () => (
  ...
  <div>
    ...
    <p>The tokens can earn you some awesome prizes. The discovery of each individual token can earn you a prize, but only if you're the first hunter to find it. If you are lucky enough to find all five tokens, you're in for the grand prize. The prizes can be claimed during the Party on Friday night. Good luck!</p>
    <hr/>
    <h2>Instructions</h2>
    <ol>
      <li>Download Status browser on your mobile device.</li>
